...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="pazienti.php" class="<?php echo ($currentPage == 'pazienti') ? 'active' : ''; ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="catalogo_gestione.php" class="<?php echo ($currentPage == 'catalogo' || $currentPage == 'archivio') ? 'active' : ''; ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
